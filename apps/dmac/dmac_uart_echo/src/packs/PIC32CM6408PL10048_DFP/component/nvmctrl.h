...
#define   NVMCTRL_CTRLB_CMD_FLWR_Val          _UINT32_(0x2)                                        /* (NVMCTRL_CTRLB) Flash Write Enable - A write to a flash address writes data to the flash.  */
#define   NVMCTRL_CTRLB_CMD_FLPER_Val         _UINT32_(0x8)                                        /* (NVMCTRL_CTRLB) Flash Page Erase Enable - A write to a flash address erases the sector containing the address.  */
#define   NVMCTRL_CTRLB_CMD_FLMPER2_Val       _UINT32_(0x9)                                        /* (NVMCTRL_CTRLB) Flash 2-Sector Erase Enable - A write to a flash address erases 2 sectors containing the address.  */
#define   NVMCTRL_CTRLB_CMD_FLMPER4_Val       _UINT32_(0xA)                                        /* (NVMCTRL_CTRLB) Flash 4-Sector Erase Enable - A write to a flash address erases 4 sectors containing the address.  */
#define   NVMCTRL_CTRLB_CMD_FLMPER8_Val       _UINT32_(0xB)                                        /* (NVMCTRL_CTRLB) Flash 8-Sector Erase Enable - A write to a flash address erases 8 sectors containing the address.  */
#define   NVMCTRL_CTRLB_CMD_FLMPER16_Val      _UINT32_(0xC)                                        /* (NVMCTRL_CTRLB) Flash 16-Sector Erase Enable - A write to a flash address erases 16 sectors containing the address.  */
#define   NVMCTRL_CTRLB_CMD_FLMPER32_Val      _UINT32_(0xD)                                        /* (NVMCTRL_CTRLB) Flash 32-Sector Erase Enable - A write to a flash address erases 32 sectors containing the address.  */
#define   NVMCTRL_CTRLB_CMD_LR_Val            _UINT32_(0xE)                                        /* (NVMCTRL_CTRLB) Lock Region - Locks the region containing the address location in the ADDR register.  */
#define   NVMCTRL_CTRLB_CMD_UR_Val            _UINT32_(0xF)                                        /* (NVMCTRL_CTRLB) Unlock Region - Unlocks the region containing the address location in the ADDR register.  */
#define   NVMCTRL_CTRLB_CMD_EBOOTCFG_Val      _UINT32_(0x10)                                       /* (NVMCTRL_CTRLB) Erase BOOTCFG Page Enable - A write to an address in the BOOTCFG Page erases the BOOTCFG Page  */
#define   NVMCTRL_CTRLB_CMD_WBOOTCFG_Val      _UINT32_(0x11)                                       /* (NVMCTRL_CTRLB) Write User BOOTCFG Enable - A write to an address in the BOOTCFG Page writes that address in the BOOTCFG Page  */
#define   NVMCTRL_CTRLB_CMD_WLOCKREGION_Val   _UINT32_(0x12)                                       /* (NVMCTRL_CTRLB) Write NVMLOCKREGION Enable - A write to the NVMLOCKREGION address writes that fuse.  */
#define   NVMCTRL_CTRLB_CMD_WROMCFG_Val       _UINT32_(0x20)                                       /* (NVMCTRL_CTRLB) Write ROMCFG Page Enable - Enable writing DAL to ROMCFG page.  */
...
#define NVMCTRL_CTRLB_CMD_FLWR                (NVMCTRL_CTRLB_CMD_FLWR_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Flash Write Enable - A write to a flash address writes data to the flash. Position */
#define NVMCTRL_CTRLB_CMD_FLPER               (NVMCTRL_CTRLB_CMD_FLPER_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Flash Page Erase Enable - A write to a flash address erases the sector containing the address. Position */
#define NVMCTRL_CTRLB_CMD_FLMPER2             (NVMCTRL_CTRLB_CMD_FLMPER2_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Flash 2-Sector Erase Enable - A write to a flash address erases 2 sectors containing the address. Position */
#define NVMCTRL_CTRLB_CMD_FLMPER4             (NVMCTRL_CTRLB_CMD_FLMPER4_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Flash 4-Sector Erase Enable - A write to a flash address erases 4 sectors containing the address. Position */
#define NVMCTRL_CTRLB_CMD_FLMPER8             (NVMCTRL_CTRLB_CMD_FLMPER8_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Flash 8-Sector Erase Enable - A write to a flash address erases 8 sectors containing the address. Position */
#define NVMCTRL_CTRLB_CMD_FLMPER16            (NVMCTRL_CTRLB_CMD_FLMPER16_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Flash 16-Sector Erase Enable - A write to a flash address erases 16 sectors containing the address. Position */
#define NVMCTRL_CTRLB_CMD_FLMPER32            (NVMCTRL_CTRLB_CMD_FLMPER32_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Flash 32-Sector Erase Enable - A write to a flash address erases 32 sectors containing the address. Position */
...
#define NVMCTRL_CTRLB_CMD_EBOOTCFG            (NVMCTRL_CTRLB_CMD_EBOOTCFG_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Erase BOOTCFG Page Enable - A write to an address in the BOOTCFG Page erases the BOOTCFG Page Position */
#define NVMCTRL_CTRLB_CMD_WBOOTCFG            (NVMCTRL_CTRLB_CMD_WBOOTCFG_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Write User BOOTCFG Enable - A write to an address in the BOOTCFG Page writes that address in the BOOTCFG Page Position */
#define NVMCTRL_CTRLB_CMD_WLOCKREGION         (NVMCTRL_CTRLB_CMD_WLOCKREGION_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Write NVMLOCKREGION Enable - A write to the NVMLOCKREGION address writes that fuse. Position */
#define NVMCTRL_CTRLB_CMD_WROMCFG             (NVMCTRL_CTRLB_CMD_WROMCFG_Val << NVMCTRL_CTRLB_CMD_Pos) /* (NVMCTRL_CTRLB) Write ROMCFG Page Enable - Enable writing DAL to ROMCFG page. Position */
...
#define NVMCTRL_PARAM_RESETVALUE              _UINT32_(0x7000000)                                  /*  (NVMCTRL_PARAM) NVM Parameters  Reset Value */
...
#define NVMCTRL_LOCK_RESETVALUE               _UINT32_(0xFFFF)                                     /*  (NVMCTRL_LOCK) Lock Section  Reset Value */

#define NVMCTRL_LOCK_LOCK0_Pos                _UINT32_(0)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK0_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK0_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK1_Pos                _UINT32_(1)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK1_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK1_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK2_Pos                _UINT32_(2)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK2_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK2_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK3_Pos                _UINT32_(3)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK3_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK3_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK4_Pos                _UINT32_(4)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK4_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK4_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK5_Pos                _UINT32_(5)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK5_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK5_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK6_Pos                _UINT32_(6)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK6_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK6_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK7_Pos                _UINT32_(7)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK7_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK7_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK8_Pos                _UINT32_(8)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK8_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK8_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK9_Pos                _UINT32_(9)                                          /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK9_Msk                (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK9_Pos)            /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK10_Pos               _UINT32_(10)                                         /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK10_Msk               (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK10_Pos)           /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK11_Pos               _UINT32_(11)                                         /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK11_Msk               (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK11_Pos)           /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK12_Pos               _UINT32_(12)                                         /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK12_Msk               (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK12_Pos)           /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK13_Pos               _UINT32_(13)                                         /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK13_Msk               (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK13_Pos)           /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK14_Pos               _UINT32_(14)                                         /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK14_Msk               (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK14_Pos)           /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK15_Pos               _UINT32_(15)                                         /* (NVMCTRL_LOCK) Region # Lock Bits Position */
#define NVMCTRL_LOCK_LOCK15_Msk               (_UINT32_(0x1) << NVMCTRL_LOCK_LOCK15_Pos)           /* (NVMCTRL_LOCK) Region # Lock Bits Mask */
...
#define NVMCTRL_LOCK_LOCK_Pos                 _UINT32_(0)                                          /* (NVMCTRL_LOCK Position) Region # Lock Bits */
...
#define NVMCTRL_WPCTRL_WPLCK_Pos              _UINT32_(1)                                          /* (NVMCTRL_WPCTRL) WPCTRL Write Lock Position */
#define NVMCTRL_WPCTRL_WPLCK_Msk              (_UINT32_(0x1) << NVMCTRL_WPCTRL_WPLCK_Pos)          /* (NVMCTRL_WPCTRL) WPCTRL Write Lock Mask */
