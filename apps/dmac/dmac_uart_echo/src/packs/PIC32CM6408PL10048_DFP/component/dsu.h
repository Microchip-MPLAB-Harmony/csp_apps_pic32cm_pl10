...
#define DSU_WPCTRL_WPLCK_Pos                  _UINT32_(1)                                          /* (DSU_WPCTRL) WPCTRL Write Lock Position */
#define DSU_WPCTRL_WPLCK_Msk                  (_UINT32_(0x1) << DSU_WPCTRL_WPLCK_Pos)              /* (DSU_WPCTRL) WPCTRL Write Lock Mask */
...
#define DSU_STATUSB_BCCD0_Pos                 _UINT32_(0)                                          /* (DSU_STATUSB) Boot ROM Communication Channel # Dirty [x = 1..0] Position */
#define DSU_STATUSB_BCCD0_Msk                 (_UINT32_(0x1) << DSU_STATUSB_BCCD0_Pos)             /* (DSU_STATUSB) Boot ROM Communication Channel # Dirty [x = 1..0] Mask */
...
#define DSU_STATUSB_BCCD1_Pos                 _UINT32_(1)                                          /* (DSU_STATUSB) Boot ROM Communication Channel # Dirty [x = 1..0] Position */
#define DSU_STATUSB_BCCD1_Msk                 (_UINT32_(0x1) << DSU_STATUSB_BCCD1_Pos)             /* (DSU_STATUSB) Boot ROM Communication Channel # Dirty [x = 1..0] Mask */
...
#define DSU_STATUSB_DCCD0_Pos                 _UINT32_(2)                                          /* (DSU_STATUSB) Debug Communication Channel # Dirty [x = 1..0] Position */
#define DSU_STATUSB_DCCD0_Msk                 (_UINT32_(0x1) << DSU_STATUSB_DCCD0_Pos)             /* (DSU_STATUSB) Debug Communication Channel # Dirty [x = 1..0] Mask */
...
#define DSU_STATUSB_DCCD1_Pos                 _UINT32_(3)                                          /* (DSU_STATUSB) Debug Communication Channel # Dirty [x = 1..0] Position */
#define DSU_STATUSB_DCCD1_Msk                 (_UINT32_(0x1) << DSU_STATUSB_DCCD1_Pos)             /* (DSU_STATUSB) Debug Communication Channel # Dirty [x = 1..0] Mask */
...
#define DSU_STATUSB_BCCD_Pos                  _UINT32_(0)                                          /* (DSU_STATUSB Position) Boot ROM Communication Channel # Dirty [x = x..x] */
...
#define DSU_STATUSB_DCCD_Pos                  _UINT32_(2)                                          /* (DSU_STATUSB Position) Debug Communication Channel # Dirty [x = x..x] */
...
/* -------- DSU_DCC : (DSU Offset: 0x118) (R/W 32) Debug Communication Channel 0 -------- */
...
#define   DSU_DAL_CPU0_SECURED_Val            _UINT32_(0x0)                                        /* (DSU_DAL) The Debugger targeting the CPU0 domain can only access the DSU external address space. Otherwise, the debugger access is disabled.  */
#define   DSU_DAL_CPU0_FULL_DEBUG_Val         _UINT32_(0x2)                                        /* (DSU_DAL) The Debugger has unrestricted access  */
#define DSU_DAL_CPU0_SECURED                  (DSU_DAL_CPU0_SECURED_Val << DSU_DAL_CPU0_Pos)       /* (DSU_DAL) The Debugger targeting the CPU0 domain can only access the DSU external address space. Otherwise, the debugger access is disabled. Position */
...
#define DSU_ENTRY0_RESETVALUE                 _UINT32_(0x9C0FF002)                                 /*  (DSU_ENTRY0) CoreSight ROM Table Entry 0  Reset Value */
...
#define DSU_ENTRY1_RESETVALUE                 _UINT32_(0xFD008002)                                 /*  (DSU_ENTRY1) CoreSight ROM Table Entry 1  Reset Value */
...
#define DSU_ENTRY2_RESETVALUE                 _UINT32_(0x02)                                       /*  (DSU_ENTRY2) CoreSight ROM Table Entry 2  Reset Value */
...
#define DSU_ENTRY3_RESETVALUE                 _UINT32_(0x02)                                       /*  (DSU_ENTRY3) CoreSight ROM Table Entry 3  Reset Value */
...
#define DSU_PID2_RESETVALUE                   _UINT32_(0x3A)                                       /*  (DSU_PID2) CoreSight Peripheral Identification 2  Reset Value */
...
#define DSU_DCC_REG_OFST               _UINT32_(0x118)     /* (DSU_DCC) Debug Communication Channel 0 Offset */
#define DSU_DCC0_REG_OFST              _UINT32_(0x118)     /* (DSU_DCC0) Debug Communication Channel 0 Offset */
#define DSU_DCC1_REG_OFST              _UINT32_(0x11C)     /* (DSU_DCC1) Debug Communication Channel 0 Offset */
...
{  /* Device Service Unit */
  ...
  __IO  uint32_t                       DSU_DCC[2];         /* Offset: 0x118 (R/W  32) Debug Communication Channel 0 */
