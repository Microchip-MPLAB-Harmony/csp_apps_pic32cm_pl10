...
#define CCL_SEQCTRL_SEQSEL0_Pos               _UINT32_(0)                                          /* (CCL_SEQCTRL) Sequential Selection Position */
#define CCL_SEQCTRL_SEQSEL0_Msk               (_UINT32_(0xF) << CCL_SEQCTRL_SEQSEL0_Pos)           /* (CCL_SEQCTRL) Sequential Selection Mask */
...
#define CCL_SEQCTRL_SEQSEL1_Pos               _UINT32_(8)                                          /* (CCL_SEQCTRL) Sequential Selection Position */
#define CCL_SEQCTRL_SEQSEL1_Msk               (_UINT32_(0xF) << CCL_SEQCTRL_SEQSEL1_Pos)           /* (CCL_SEQCTRL) Sequential Selection Mask */
...
#define CCL_LUTCTRL_INSEL0_Pos                _UINT32_(8)                                          /* (CCL_LUTCTRL) LUT Input # Source Selection Position */
#define CCL_LUTCTRL_INSEL0_Msk                (_UINT32_(0xF) << CCL_LUTCTRL_INSEL0_Pos)            /* (CCL_LUTCTRL) LUT Input # Source Selection Mask */
...
#define CCL_LUTCTRL_INSEL1_Pos                _UINT32_(12)                                         /* (CCL_LUTCTRL) LUT Input # Source Selection Position */
#define CCL_LUTCTRL_INSEL1_Msk                (_UINT32_(0xF) << CCL_LUTCTRL_INSEL1_Pos)            /* (CCL_LUTCTRL) LUT Input # Source Selection Mask */
...
#define CCL_LUTCTRL_INSEL2_Pos                _UINT32_(16)                                         /* (CCL_LUTCTRL) LUT Input # Source Selection Position */
#define CCL_LUTCTRL_INSEL2_Msk                (_UINT32_(0xF) << CCL_LUTCTRL_INSEL2_Pos)            /* (CCL_LUTCTRL) LUT Input # Source Selection Mask */
...
#define CCL_WPCTRL_WPLCK_Pos                  _UINT32_(1)                                          /* (CCL_WPCTRL) WPCTRL Write Lock Position */
#define CCL_WPCTRL_WPLCK_Msk                  (_UINT32_(0x1) << CCL_WPCTRL_WPLCK_Pos)              /* (CCL_WPCTRL) WPCTRL Write Lock Mask */
